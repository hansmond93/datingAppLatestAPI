...
namespace API.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Member>>> GetMembers([FromQuery] MemberParams memberParams)
        {
        ...
        [HttpGet("{id}/photos")]
        public async Task<ActionResult<IEnumerable<Photo>>> GetMembersPhoto(string id)
        {
        ...
        public async Task<ActionResult> UpdateMember(MemberUpdateDto memberUpdateDto)
        {
            ...
            if (memberId == null) return BadRequest("Opps - no id is found");
        ...
        public async Task<ActionResult<Photo>> AddPhoto([FromForm] IFormFile file )
        {
            ...
            if (member == null) return BadRequest("Opps - no id is found");
